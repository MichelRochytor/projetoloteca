...
def exibir_jogos_por_rodada(df, rodada_desejada):
    ...
    if not jogo_vasco_flamengo.empty:
        ...
        print(f"Vasco (mandante): Saldo últimos 5 em casa: {jogo['Saldo_Ultimos_5_Casa_Mandante']}, Sequência: {jogo['Sequencia_5_Mandante']}")
        print(f"Flamengo (visitante): Saldo últimos 5 fora: {jogo['Saldo_Ultimos_5_Fora_Visitante']}, Sequência: {jogo['Sequencia_5_Visitante']}")
