...
def exibir_jogos_por_rodada(df, rodada_desejada):
    ...
    print("\n📊 LEGENDA:")
    print("SGC(M): Saldo completo de gols do Mandante em casa (toda temporada)")
    print("SGF(V): Saldo completo de gols do Visitante fora (toda temporada)")
    ...
    if not jogo_vasco_flamengo.empty:
        ...
        print(f"Vasco (mandante): Saldo completo em casa: {jogo['Saldo_Gols_Casa_Mandante']}, Últimos 5 em casa: {jogo['Saldo_Ultimos_5_Casa_Mandante']}, Sequência: {jogo['Sequencia_5_Mandante']}")
        print(f"Flamengo (visitante): Saldo completo fora: {jogo['Saldo_Gols_Fora_Visitante']}, Últimos 5 fora: {jogo['Saldo_Ultimos_5_Fora_Visitante']}, Sequência: {jogo['Sequencia_5_Visitante']}")
